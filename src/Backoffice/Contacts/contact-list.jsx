              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="left" ><a href="/contactDetails">#{row.ref}</a></TableCell>
                    ...
                    <TableCell align="right">
                         <Label  color={(row.status === 'New' && 'warning') ||(row.status === 'Pending' && 'secondary') || (row.status === 'Closed' && 'error')  || 'success'}>{row.status }</Label>
                    </TableCell>
            ...
            <Fade in={editModalOpen}>
                <Card sx={style}>
                    <AddContactForm
                        ...
                        user={selectedUser}
                        closeEvent={() => setEditModalOpen(false)}
                        isEdit={isEdit} // Pass isEdit to AddContactForm
