...
const AppBar = styled(MuiAppBar, {
  ...
  zIndex: theme.zIndex.drawer - 1, // Ensure AppBar is beneath the Drawer
}));
...
export default function PrimarySearchAppBar(userToken) {

  console.log("NAAAVBAAAR", userToken.userToken);
