...
export default function CategoryFil({searchTerm, onSearch}) {
 ...
 // const [selectedSubcategory, setSelectedSubcategory] = useState(null);
  ...
  //  const handleSubcategorySelect = (event, category) => {
  //   event.preventDefault();
  //   setCategory(category);
  //   console.log("RRRRRRRRRR", category);
  // };

  const handleSubcategorySelect = (category, event) => {
                    ...
                    <ul role="list" className="px-2 py-3 font-medium text-gray-900">
                      ...
                      {subCategories.map((category) => (
                        <li key={category.name}>
                           <button onClick={ (event) => handleSubcategorySelect(category.name, event) }>{category.name}</button>
                        </li>
                      ))}
                    </ul>
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div className="lg:col-span-3">
                 {/* <ProductComponent /> */}
                  <ProductComponent category={category} searchTerm={searchTerm} />
              </div>
